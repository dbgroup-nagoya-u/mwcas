...
- `MWCAS_VALUE_BIT_NUM`: The maximum number of bits for representing values (default: `48`). This parameter is used only in `dbgroup::atomic::mwcas::lock_free::MwCASDescriptor`.
