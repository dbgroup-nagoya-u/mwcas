...
This repository is an open source implementation of MwCAS (multi-words compare-and-swap) for research use. This implementation is based on the NCAS (n-words compare-and-swap) operation [1] with some optimizations.
